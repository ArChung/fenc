...
<script>
    $(document).ready(function() {
        $(".pBtn").eq(0).on("click", function () {
            $("#btn16-18").stop().slideUp(function(){
                $("#btn11-13").stop().slideDown();
            });
        });
        $(".pBtn").eq(1).on("click", function () {
            $("#btn11-13").stop().slideUp(function(){
                $("#btn16-18").stop().slideDown();
            });
        });
    });
</script>
...
<body>
    ...
    <div class="formPage page">
        ...
        <div class="mainContainer thinContainer">
            <h1 class="pageTitle wTxt">Plan to Meet Us</h1>
            <form runat="server" method="post" onsubmit="javascript:return checkForm(this);">
                <div class="whiteBox">
                    <div class="qBox mb_b">
                        <h1>Which Exhibition ?</h1>
                        <div class="btnBox difBox mt_s">
                            <div class="pBtn">
                                <input type="radio" name="exhibition" value="11-13 Oct Intertextile Shanghai" <%= ((Request.QueryString["exhibition"] == "1") ? ("checked=\"checked\"") : ("")) %> id="exhibition1">
                                <label for="exhibition1">
                                    <h1>11-13 Oct</h1>
                                    <h2>Intertextile<br>Shanghai</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="exhibition" value="16-18 Oct TITAS TAIPEI" <%= ((Request.QueryString["exhibition"] == "2") ? ("checked=\"checked\"") : ("")) %> id="exhibition2">
                                <label for="exhibition2">
                                    <h1>16-18 Oct</h1>
                                    <h2 class="mt_ss">TITAS TAIPEI</h2>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="qBox mb_b" style="height: 120px;">
                        <h1>Which Date ?</h1>
                        <div class="btnBox difBox mt_s threeRowBox" id="btn11-13" <%= ((Request.QueryString["exhibition"] == "1") ? ("") : ("style=\"display: none;\"")) %>>
                            <div class="pBtn">
                                <input type="radio" name="date" value="11 Oct" id="date11Oct">
                                <label for="date11Oct">
                                    <h2>11 Oct</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="date" value="12 Oct" id="date12Oct">
                                <label for="date12Oct">
                                    <h2>12 Oct</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="date" value="13 Oct" id="date13Oct">
                                <label for="date13Oct">
                                    <h2>13 Oct  </h2>
                                </label>
                            </div>
                        </div>
                        <div class="btnBox difBox mt_s threeRowBox" id="btn16-18"  <%= ((Request.QueryString["exhibition"] == "2") ? ("") : ("style=\"display: none;\"")) %>>
                            <div class="pBtn">
                                <input type="radio" name="date" value="16 Oct" id="date16Oct">
                                <label for="date16Oct">
                                    <h2>16 Oct</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="date" value="17 Oct" id="date17Oct">
                                <label for="date17Oct">
                                    <h2>17 Oct</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="date" value="18 Oct" id="date18Oct">
                                <label for="date18Oct">
                                    <h2>18 Oct  </h2>
                                </label>
                            </div>
                    ...
                    <div class="qBox mb_b">
                        ...
                        <div class="btnBox difBox mt_s threeRowBox">
                            <div class="pBtn">
                                <input type="radio" name="time" value="9:00-10:00" id="time9_10">
                                <label for="time9_10">
                                    <h2>9:00-10:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="10:00-11:00" id="time10_11">
                                <label for="time10_11">
                                    <h2>10:00-11:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="11:00-12:00" id="time11_12">
                                <label for="time11_12">
                                    <h2>11:00-12:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="12:00-13:00" id="time12_13">
                                <label for="time12_13">
                                    <h2>12:00-13:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="13:00-14:00" id="time13_14">
                                <label for="time13_14">
                                    <h2>13:00-14:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="14:00-15:00" id="time14_15">
                                <label for="time14_15">
                                    <h2>14:00-15:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="15:00-16:00" id="time15_16">
                                <label for="time15_16">
                                    <h2>15:00-16:00</h2>
                                </label>
                            </div>
                            <div class="pBtn">
                                <input type="radio" name="time" value="16:00-17:00" id="time16_17">
                                <label for="time16_17">
                                    <h2>16:00-17:00</h2>
                                </label>
                            </div>
...
%>
    ...
    <script type="text/javascript">
        function checkForm(form) {
            if (check_no_checked(form.elements['exhibition'])) {
                alert('Exhibition is required');
                return false;
            }
            if (check_no_checked(form.elements['date'])) {
                alert('Date is required');
                return false;
            }
            if (check_no_checked(form.elements['time'])) {
